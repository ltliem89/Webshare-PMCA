...
const accessUrl = isAdmin ? project.url : getGoUrl(window.location, project.url, { title: project.title, authorName: project.authorName, authorEmail: project.authorContact });
